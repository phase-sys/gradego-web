      ...
      <main className="flex-grow">
        ...
        <section className="py-20 md:py-32 text-center container mx-auto px-4">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 text-foreground leading-tight">
            ClassFlow: <span className="text-primary">Simplify</span> Your Teaching
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto">
            The all-in-one platform designed by teachers, for teachers. Streamline class management, grading, and student engagement effortlessly.
          </p>
          ...
          <div className="mt-12 text-sm text-muted-foreground">
              <p className="flex items-center justify-center space-x-4">
                  <span className="flex items-center"><Check className="h-4 w-4 text-green-500 mr-1" /> No Credit Card Required</span>
                  <span className="flex items-center"><Check className="h-4 w-4 text-green-500 mr-1" /> Mobile-First Design</span>
              </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-muted/40">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-12">Core Features Built for Efficiency</h2>
        ...
        <section className="py-20 text-center container mx-auto px-4">
            ...
            <p className="text-lg text-muted-foreground mb-8">
                Join thousands of educators who are saving time and focusing more on teaching.
            </p>
            <div className="space-x-4">
                ...
                <Button asChild variant="link" size="lg">
                    <Link href="/enroll">Student Enrollment</Link>
                </Button>
            </div>
        </section>
